...
const ACCENT_MAP = {
    emerald: {
        light: "oklch(0.455 0.125 170)",
        dark: "oklch(0.675 0.135 168)",
        h: 170
    },
    ocean: {
        light: "oklch(0.455 0.125 220)",
        dark: "oklch(0.675 0.135 218)",
        h: 220
    },
    sunset: {
        light: "oklch(0.555 0.155 35)",
        dark: "oklch(0.735 0.155 33)",
        h: 35
    },
    rose: {
        light: "oklch(0.495 0.155 350)",
        dark: "oklch(0.695 0.155 348)",
        h: 350
    },
    violet: {
        light: "oklch(0.495 0.155 290)",
        dark: "oklch(0.695 0.155 288)",
        h: 290
    }
};
const ACCENT_LABELS = {
...
const useThemeCustomStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["create"])((set, get)=>({
        config: loadConfig(),
        setConfig: (partial)=>{
            const config = {
                ...get().config,
            ...
            if ("TURBOPACK compile-time truthy", 1) localStorage.setItem("aspidus-theme-config", JSON.stringify(config));
            set({
                config
            });
            // Apply immediately
...
function ThemeInitializer() {
    _s();
    const applyTheme = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$store$2f$theme$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useThemeCustomStore"])({
        "ThemeInitializer.useThemeCustomStore[applyTheme]": (s)=>s.applyTheme
    }["ThemeInitializer.useThemeCustomStore[applyTheme]"]);
...
_s(ThemeInitializer, "KW2LdNyxukH/HC24fk4NiTjVkKM=", false, function() {
    return [
...
_s1(Providers, "B8jyyUvVkZsNprfYHj+dtHVImNc=");
_c1 = Providers;
var _c, _c1;
...
//# sourceMappingURL=src_1856e5ca._.js.map