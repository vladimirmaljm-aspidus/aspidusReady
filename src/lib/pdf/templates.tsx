...
export function buildPdfDocument({
  ...
  const FooterContent = () => {
    ...
    return (
      ...
      {/* Page number — separate fixed element (render doesn't work
          inside a nested fixed View in react-pdf v4) */}
      <View fixed style={{ position: "absolute", bottom: mmToPoints(4), right: marginLeft, width: 100, alignItems: "flex-end" }}>
        <Text
          style={{ fontSize: 7, color: "#999", fontFamily: headingFontFamily }}
