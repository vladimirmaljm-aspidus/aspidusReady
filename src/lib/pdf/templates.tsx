      ...
      <View style={styles.footerRow}>
        ...
        <View style={styles.footerRight}>
          ...
          <Text style={styles.footerSys}>
            Generated by {(pdfMeta?.creator || "Aspidus CRM")} · {new Date().toLocaleString("en-US")}
          </Text>
        </View>
      </View>
    </View>
      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.docHeader}>
          <View>
            ...
            <Text style={styles.docSubtitle}>{doc.subject}</Text>
          </View>
          <View style={styles.docMeta}>
            ...
            <View style={styles.docMetaRow}>
              ...
              <Text style={styles.docMetaValue}>
                {new Date((doc as any).issue_date || doc.created_at).toLocaleDateString("en-US")}
              </Text>
            </View>
            {docType === "offer" && (doc as Offer).valid_until && (
              <View style={styles.docMetaRow}>
                ...
                <Text style={styles.docMetaValue}>
                  {new Date((doc as Offer).valid_until as string).toLocaleDateString("en-US")}
                </Text>
              </View>
            )}
            {(docType === "invoice" || docType === "proforma") && (doc as any).due_date && (
              <View style={styles.docMetaRow}>
                ...
                <Text style={styles.docMetaValue}>
                  {new Date((doc as any).due_date).toLocaleDateString("en-US")}
                </Text>
              </View>
            )}
            <View style={styles.docMetaRow}>
